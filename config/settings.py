...
class Settings:
    def __init__(self, settings_yaml, generate_log=True):
        ...
        with open(settings_yaml, 'r') as stream:
            ...
            self.feature_maps = dataset_specs["feature_maps"]
            self.steps = dataset_specs["steps"]
            self.min_sizes = dataset_specs["min_sizes"]
            self.max_sizes = dataset_specs["max_sizes"]
            self.aspect_ratios = dataset_specs["aspect_ratios"]
            self.anchor_boxes = dataset_specs["anchor_boxes"]
            self.variance = dataset_specs["variance"]
            self.clip = dataset_specs["clip"]
