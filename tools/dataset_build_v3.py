...
def split_file(file_path, save_path, file_name, height, width, delta_t=None, skip=None):
    ...
    while not sum([video.done for video in event_videos]):
        ...
        if len(npz_e) == 10:
            ...
            np.savez(save_event_file, e0=npz_e[0], e1=npz_e[1], e2=npz_e[2], e3=npz_e[3], e4=npz_e[4],
                     e5=npz_e[5], e6=npz_e[6], e7=npz_e[7], e8=npz_e[8], e9=npz_e[9])
            np.savez(save_box_file, l0=npz_l[0], l1=npz_l[1], l2=npz_l[2], l3=npz_l[3], l4=npz_l[4],
...
if __name__ == "__main__":
    ...
    save_dir = "/home/wds/Desktop/prophesee_gen4_npz_uncompress/train/trainfilelist14"
